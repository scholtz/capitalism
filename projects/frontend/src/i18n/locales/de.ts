export default {
  ...
  resourceDetail: {
    ...
    notFoundHint: 'Der angeforderte Rohstoff konnte nicht gefunden werden. Kehren Sie zur Enzyklopädie zurück, um verfügbare Rohstoffe zu durchsuchen.',
    loadFailed: 'Rohstoffdaten konnten nicht geladen werden',
    category: 'Kategorie',
    basePrice: 'Basispreis',
    weight: 'Gewicht',
    unit: 'Einheit',
    usedInProducts: 'Verwendet in Produkten',
    usedInProductsHelp: 'Alle hergestellten Produkte, die diesen Rohstoff als Zutat benötigen.',
    noProductsUsingResource: 'Derzeit verwendet kein Produkt diesen Rohstoff.',
