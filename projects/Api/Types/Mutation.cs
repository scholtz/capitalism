...
/// Handles authentication, admin, company management, and onboarding.
/// Split across multiple partial files, one per domain:
/// <list type="bullet">
/// <item><see cref="Mutation"/> (this file) — auth, admin, news, company, onboarding</item>
/// <item><c>Mutation.Building.cs</c> — building configuration, sales, rent, lot purchase, storage flushing, unit upgrades</item>
